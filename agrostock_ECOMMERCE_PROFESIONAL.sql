-- =====================================================
-- 🛒 AGROSTOCK - BASE DE DATOS E-COMMERCE PROFESIONAL
-- Versión: 2.0.0 E-COMMERCE
-- Fecha: 2025-01-XX
-- =====================================================
-- Base de datos optimizada para e-commerce
-- Incluye: carrito, pedidos, pagos, imágenes, reseñas
-- =====================================================
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  `imagenes_adicionales` json DEFAULT NULL COMMENT 'Array JSON con URLs de imágenes adicionales',
...
CREATE TABLE IF NOT EXISTS `reseñas` (
  ...
  UNIQUE KEY `pedido_resena` (`id_pedido`),
  KEY `id_producto` (`id_producto`),
  KEY `id_consumidor` (`id_consumidor`),
  KEY `id_productor` (`id_productor`),
...
-- Usuario administrador (password debe ser hasheado en producción)
